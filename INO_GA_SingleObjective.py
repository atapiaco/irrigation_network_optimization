...
toolbox.register("evaluate",        GenOps.Fitness_RelFlowDev)
...
if __name__ == "__main__":
    ...
    for c,m in zip(valores_c, valores_m): 
        ...
        res_individuos = open('Resultados/RES_SO' + '/IND_' + str(c) + '_' + str(m) + '.txt', "a")
        res_fitness    = open('Resultados/RES_SO' + '/FIT_' + str(c) + '_' + str(m) + '.txt', "a")
        ...
        for i in range(Nsim): 
              ...
              log_filename = 'Resultados/RES_SO' + '/LOG_' + str(c) + '_' + str(m) + '_IT' + str(i+1) + '.csv'
